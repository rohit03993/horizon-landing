...
export default function CTA() {
  ...
  return (
    <section id="contact" className="py-20 md:py-32 bg-black relative overflow-x-hidden">
      {/* Background Pattern */}
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="space-y-6">
              ...
              <ScrollAnimation delay={300}>
                <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl">
                <div className="text-center mb-6">
                  <div className="inline-flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-yellow-400 rounded-full mb-4">
                    <svg
                      className="w-7 h-7 sm:w-8 sm:h-8 text-black"
                      fill="none"
                      stroke="currentColor"
