...
export default function VideoPlayer({ 
  ...
  if (isYouTube && youtubeVideoId) {
    ...
    // Simplified parameters to avoid Error 153 - minimal required params only
    const baseParams = `autoplay=1&mute=1&controls=1&rel=0&playsinline=1`;
    const embedUrl = isShorts 
      ? `https://www.youtube-nocookie.com/embed/${youtubeVideoId}?${baseParams}&loop=1`
      : `https://www.youtube-nocookie.com/embed/${youtubeVideoId}?${baseParams}`;
